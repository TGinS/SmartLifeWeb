class InvitationController < ApplicationController
  ...
  def show
    ...
    @invitation_candidates = InvitationCandidate.find_by_sql(['SELECT invitation_candidates.id AS candidate_id, provisions.id AS provisions_id, provisions.name, COUNT(*) AS vote
                                                            ...
                                                            GROUP BY provisions_id, provisions.name',id])
