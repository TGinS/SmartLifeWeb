class ProvisionController < ApplicationController
  def show
    ...
    @provision_candidates = ProvisionCandidate.find_by_sql(['SELECT invitations.id AS invitation_id, invitations.name, COUNT(*) AS vote
                                                            ...
                                                            GROUP BY invitation_id, invitations.name',id])
  end
end
