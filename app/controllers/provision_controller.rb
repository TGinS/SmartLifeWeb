class ProvisionController < ApplicationController
  ...
  def show
    ...
    @provision_candidates = ProvisionCandidate.find_by_sql(['SELECT provision_candidates.id AS candidates_id, invitations.id AS invitations_id, invitations.name, COUNT(*) AS vote
                                                            ...
                                                            GROUP BY candidates_id, invitations_id, invitations.name',id])
  end
end
